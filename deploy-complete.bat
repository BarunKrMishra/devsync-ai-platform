...
REM This script helps you deploy both frontend and backend to your development server
...
ssh %SERVER_USER%@%SERVER_IP% "curl -f http://localhost:3000 >/dev/null 2>&1 && echo ✅ Frontend is accessible || echo ❌ Frontend is not accessible"
